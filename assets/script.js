    ...
    $('#btn-open').click(function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Era uma vez...',
                    html: '<img src="https://usagif.com/wp-content/uploads/2022/4hv9xm/crying-emoji-9.gif" style="max-width: 300px;">' +
                    ...
                    Swal.fire({
                        title: 'E então...',
                        html: '<img src="https://usagif.com/wp-content/uploads/gif/blushing-39.gif" style="max-width: 300px;">' +
                        ...
                        Swal.fire({
                            title: 'Até que...',
                            html: '<img src="https://usagif.com/wp-content/uploads/gifs/sun-84.gif" style="max-width: 300px;">' +
                            ...
                            Swal.fire({
                                title: 'Finalmente...',
                                html: '<img src="https://usagif.com/wp-content/uploads/gif-heart-47.gif" style="max-width: 300px;">' +
                                ...
                                Swal.fire({
                                    title: 'E então...',
                                    html: '<img src="https://usagif.com/wp-content/uploads/anime-love-29.gif" style="max-width: 300px;">' +
                                    ...
                                    Swal.fire({
                                        title: 'Bom...',
                                        html: '<img src="https://usagif.com/wp-content/uploads/anime-love-13.gif" style="max-width: 300px;">' +
                                        ...
                                        Swal.fire({
                                            title: 'Ah...',
                                            icon: 'info',
                                            html: '<img src="https://usagif.com/wp-content/uploads/gif/anime-hug-73.gif" style="max-width: 300px;">' +
                                            ...
                                            Swal.fire({
                                                title: 'Sabe?',
                                                icon: 'success',
                                                html: '<img src="https://usagif.com/wp-content/uploads/anime-love-56.gif" style="max-width: 300px;">' +
